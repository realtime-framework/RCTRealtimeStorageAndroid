...
public class CustomReactPackage implements ReactPackage {
    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
        return Arrays.asList(new NativeModule[]{new RealtimeStorageAndroid(reactContext), new AsyncStorageModule(reactContext), new FrescoModule(reactContext), new NetworkingModule(reactContext), new ToastModule(reactContext)});
    }
